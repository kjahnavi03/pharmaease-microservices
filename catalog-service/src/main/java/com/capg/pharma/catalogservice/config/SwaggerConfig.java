...
/**
 * Swagger / OpenAPI 3 configuration for the Catalog Service.
 * Swagger UI: {@code http://localhost:9092/swagger-ui.html}
 */
@Configuration
    ...
    public OpenAPI catalogServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Medicine catalog, categories, and prescription management")
                        .version("1.0.0"))
